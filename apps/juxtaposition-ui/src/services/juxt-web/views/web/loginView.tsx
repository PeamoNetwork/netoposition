		...
		<WebLoginRoot head={extraHead}>
			...
			<div className="wrapper">
				<div className="account-form-wrapper">
					<a className="logotype" href="https://ixchats.com">
						<PretendoLogo />
					</a>
					<form action="/login" method="post" className="account">
						...
						<div>
							...
							<a href="https://ixchats.com/account/forgot-password" className="pwdreset"><T k="login.forgot_password" /></a>
						</div>
						<input name="grant_type" id="grant_type" type="hidden" value="password" />
						<div className="buttons">
							<button type="submit"><T k="login.login_action" /></button>
							<a href="https://ixchats.com/account/register" className="register"><T k="login.no_account" /></a>
						</div>
